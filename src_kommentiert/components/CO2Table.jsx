...
//            Struktur:
//              [{ id, land, unternehmen: [ { id, name, emission }, ... ] }, ...]
//            Die IDs werden zentral in App.jsx (datenMitIds) vergeben.
// ============================================================================
        ...
        <tbody>
          ...
          {data.map((landGruppe) => {
            ...
            return (
              ...
              // key (Land-ID) ist nötig, damit React Listen effizient aktualisieren kann.
                ...
                {landGruppe.unternehmen.map((u, i) => (
                  <tr key={u.id}>
                    {/* Land-Spalte nur in der ERSTEN Zeile des Landes ausgeben.
                        ...
                        damit das Land optisch nur einmal erscheint. */}
                    {i === 0 && (
                      <td
